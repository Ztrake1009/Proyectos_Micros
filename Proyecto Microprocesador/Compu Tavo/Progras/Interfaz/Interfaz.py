...
class Interfaz:
    ...
    def Modo1(self):
        ...
        self.X_Final = self.X_Actual + self.tam_Celdas_Carga
        self.Y_Final = self.Y_Actual + self.tam_Celdas_Carga
        self.grua = self.lienzo.create_oval(self.X_Actual, self.Y_Actual, self.X_Final, self.Y_Final, width=1, fill="orange")
    ...
    def acomodar_Cajas_1(self):
        ...
        #for pos_Carga_I, elem_Carga_I in enumerate(self.letras_Carga_Inicial):
